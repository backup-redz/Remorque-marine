    ...
    case 'H':
      {
        ...
        Serial.print('H');
        Serial.print(cekejeresoi);
        Serial.print('$');
        targetLong = cekejeresoi.toDouble();
        delay(2000);
        Blt.print(" lat : ");
        Blt.print(targetLat, 5);
        Blt.print(" long : ");
        Blt.print(targetLong, 5);
      }
    break;
    case 'G':
      {
        ...
        targetLat = cekejeresoi.toDouble();
        Serial.print('G');
        Serial.print(cekejeresoi);
        Serial.print('$');
      }
